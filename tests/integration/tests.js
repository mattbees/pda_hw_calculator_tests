...
describe('calculator functionality', function() {
  ...
  it('should allow multiple operations to be chained together', function(){
    ...
    element(by.css('#number3')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('88')
  })

  it('should handle a large range of numbers', function(){
    running_total = element(by.css('#running_total'))
    ...
    /*
    calculator does not have a decimals operator so this has not been tested
    */
    ...
    element(by.css('#number2')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('120000000')
  })

  it('should return "Not a number" if a number is divided by 0', function(){
    running_total = element(by.css('#running_total'))
